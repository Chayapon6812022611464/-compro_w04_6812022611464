...
// เมื่อเปลี่ยน GOBAL_RATE เป็น 20 หรือ LOCAL_BONUS เป็น 80 จะทำให้ค่าที่แสดงผลเปลี่ยนเป็น 20 หรือ 80
// เหตุผลที่ LOCAL_BONUS ไม่สามารถถูกเรียกใช้ใน main() ไม่ได้เพราะ LOCAL_BONUS ถูกประกาศภายในฟังก์ชัน calculate() แสดงผลได้เเค่ในฟังก์ชัน calculate() จึงทำให้เรียกใช้ในฟังก์ชัน main() ไม่ได้
